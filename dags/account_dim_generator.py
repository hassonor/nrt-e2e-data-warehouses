...
def generate_random_data(row_num):
    ...
    try:
        ...
        return account_id, account_type, status, customer_id, balance, opening_dates_mills
...
def generate_account_dim_data():
    ...
    try:
        ...
        while row_num <= num_rows:
            account_id, account_type, status, customer_id, balance, opening_dates_mills = generate_random_data(row_num)
