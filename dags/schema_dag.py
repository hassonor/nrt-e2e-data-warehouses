...
folder_path = Variable.get("pinot_schema_folder_path", default_var="/opt/airflow/dags/schemas")
pinot_url = Variable.get("pinot_schema_endpoint", default_var="http://pinot-controller:9000/schemas")

with DAG(
        dag_id='schema_dag',
        default_args=default_args,
        description='A DAG to submit all schemas in a folder to Apache Pinot',
    ...
    **Configuration:**
    ...
    submit_schemas = PinotSchemaSubmitOperator(
